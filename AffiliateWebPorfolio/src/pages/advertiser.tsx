  ...
  return (
    <section>
      <div className="flex px-20 py-15 items-center">
        ...
        <div>
          <h1 ref={aboutHead11} className="mb-2 info-heading text-lg">Amplify your reach</h1>
      ...
      <div className=" px-20 py-15 ">
        ...
        <div className="flex mt-20 mb-26">
          <div className="w-1/2">
            <h1 ref={servicesHead1} className="mb-2 info-heading text-lg">Campaign Management</h1>
          </div>
          <div>
        ...
        <div className="flex mt-10 mb-26">
          <div className="w-1/2">
            <h1 ref={servicesHead2} className="mb-2 info-heading text-lg">Strategic Planning</h1>
          </div>
          <div>
        ...
        <Link to="/contact">
          <button ref={ctnBtn} className="bg-[#daf700] text-black hover:bg-black hover:text-[#daf700] px-4 py-2 border rounded-full transition duration-300 paragraph">
            {" "}
            Contact Us
          </button>
        </Link>
