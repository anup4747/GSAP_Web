  ...
  return (
    <section className="mt-18 ">
      <div className="w-full flex flex-col items-center justify-center ">
        ...
        <div className="mt-8">
          <button className="pr-6 pt-3 pb-3 pl-6 border text-xl bg-[#d9f505] hover:bg-black hover:text-yellow-200 hover:cursor-pointer border-black rounded-4xl ">
            {" "}
            Start Today{" "}
          </button>
        </div>
      ...
      <div className="px-24 py-20 flex flex-col items-center">
        <div className="">
          ...
          <p className="text-md text-center paragraph mb-4">
